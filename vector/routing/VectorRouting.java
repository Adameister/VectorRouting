...
/*
 * To do list
 * - System detects a stable state
 * - 
 */

package vector.routing;
...
public class VectorRouting {
    ...
    public static void main(String[] args) {
        ...
        Router[] routers = new Router[MAX_NODES];         // my router object
    ...
    // the next two functions were made purly for degugging output and to save time.
    // they are not nessassay for the code to run
